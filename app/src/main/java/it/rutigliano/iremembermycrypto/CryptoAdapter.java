...
public class CryptoAdapter extends RecyclerView.Adapter<CryptoAdapter.ViewHolder> {
    ...
    public CryptoAdapter(ArrayList<Crypto> cryptos, OnItemClickListener onItemClickListener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int position) {
        ...
        if (crypto != null) {
            ...
            viewHolder.getPrice().setText(viewHolder.itemView.getContext().getString(R.string.price_format, crypto.getPrice()));
       ...
       viewHolder.itemView.setOnClickListener(v -> onItemClickListener.onItemClick(crypto, position));
    }
